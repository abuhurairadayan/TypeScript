let numArray = [10, 20, 30]; // array writing style in js

let stringArray = ["ahmad" , "tufail", "hania"]; // array writing style in js
...
let stringArr: string[] = ["ahmad" , "tufail", "hania"];
...
let uniArr: (string | number)[] = ["huraira", 21 , "nizam", 22]
